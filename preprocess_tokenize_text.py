...
def tokenize_worker(args):
    ...
    chunk, tokenizer_path, max_length, cache_dir, local_files_only, trust_remote_code = args
...
def pre_tokenize_dataset_parallel(
    ...
    worker_args = [
        (chunk, tokenizer_name, max_length, cache_dir, local_files_only, trust_remote_code)
        for chunk in chunks
    ]
